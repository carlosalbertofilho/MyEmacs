...
;;
;; Defun top-level (não dentro de `when'): o byte-compiler só registra
;; defuns top-level como funções conhecidas — dentro de `when' o warning
;; "not known to be defined" vira erro no gate dependendo do estado de
;; build parcial (fboundp stale). O require runtime fica no comando.
