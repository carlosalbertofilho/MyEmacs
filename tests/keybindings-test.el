...
(ert-deftest myemacs-kbd-no-collisions ()
  ...
  (let ((critical-bindings
         '(("C-c g" . magit-status)
           ...
           ("C-c D r" . +carlos/ielm-open)
           ("C-c D t" . +carlos/ert-run-buffer)
           ("C-c D T" . +carlos/ert-run-test-at-point)
           ("C-c D d" . +carlos/toggle-debug-on-error)
           ("C-c D a" . +carlos/debug-region-with-ai)
           ("C-c h" . stdheader)
           ("C-c j" . justl)
           ("C-c n n" . denote)
           ("C-c z" . olivetti-mode)
